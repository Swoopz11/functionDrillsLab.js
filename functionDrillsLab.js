...
let nameGreeting = nameCheck('Hunter')
...
const returUpper = (string) => {
  console.log(string.toUpperCase())
}

returUpper(sampleString)
...
console.log(emailCheck('huntergmail.com'))
...
function harry(gold) {
  let chocolateFrogs = Math.floor(gold/3)
  return (chocolateFrogs)
}

let totalFrogs = harry(25)
